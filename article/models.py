...
class Article(models.Model):
    ...
    # def __str__(self):
    #     return self.title  böylede sadece title gözükür ama adminde oluşturulan sınıf ile daha verimli 
    # newUser(username="sdhjasd")
    # newUser.set_password(132) bu şifreyi gizler 
    #
